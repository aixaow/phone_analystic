...
将时间戳转换为日期的函数
from_unixtime(cast(l.s_time/1000 as bigint),"yyyy-MM-dd")

from as 字段名--
这里的case when相当于java中的switch case 处理出来的pv相当于上面的col
...
创建之后生成的表查询结果如下：
2018-09-18	java_server	pv3	1
2018-09-18	website	pv1	4
2018-09-18	website	pv2	1



with as 后面要加select语句 生成的是临时表-在内存当中-语句执行完就没有了
这个语句就是将上面的查询出来的语句进行合并 同一维度下的生成一条语句
...
查询出来结果如下：
1	2	2	0	0	1	0	0	0	0	0	2018-09-18
1	1	2	4	1	0	0	0	0	0	0	2018-09-18
